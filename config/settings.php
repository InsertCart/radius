...
return [
    ...
    'general' => [
        ...
        'icon' => 'cog',
        'fields' => [
            'site_name' => ['type' => 'text', 'label' => 'Site name', 'default' => 'Custom CMS', 'rules' => 'required|string|max:120'],
            'site_tagline' => ['type' => 'text', 'label' => 'Tagline', 'default' => 'A fast, modular CMS'],
            'site_email' => ['type' => 'email', 'label' => 'Contact email', 'default' => 'hello@example.com'],
    ...
    'seo' => [
        ...
        'module' => 'seo',
        'fields' => [
            'meta_title' => ['type' => 'text', 'label' => 'Default meta title', 'default' => 'Custom CMS'],
    ...
    'mail' => [
        ...
        'fields' => [
            ...
            'mail_from_address' => ['type' => 'email', 'label' => 'From address', 'default' => 'hello@example.com'],
            'mail_from_name' => ['type' => 'text', 'label' => 'From name', 'default' => 'Custom CMS'],
