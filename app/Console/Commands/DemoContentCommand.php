...
class DemoContentCommand extends Command
{
    ...
    protected $description = 'Install sample posts, pages and products for testing, or remove them again';
    ...
    {
        if (! $this->option('force') && ! $this->confirm('Delete all demo posts, pages and products? Content you created yourself is not touched.', true)) {
            return self::FAILURE;
        }
