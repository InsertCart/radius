...
<head>
    ...
    <title>Page not found &middot; {{ setting('site_name', config('app.name')) }}</title>
...
<body class="grid h-full place-items-center bg-white px-4 text-center">
    <div class="max-w-md">
        ...
        <h1 class="mt-2 text-xl font-semibold text-slate-900">We could not find that page</h1>
        <p class="mt-2 text-slate-600">It may have been moved or removed.</p>
